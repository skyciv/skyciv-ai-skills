...
| **Build a Quick Design Calculator** | [`build-quick-design-calculator/`](./build-quick-design-calculator/SKILL.md) | Build your own hosted SkyCiv calculator — define the input form, write the engineering logic and report, add live graphics, and plug it into Structural 3D. |
...
- Add download and upload buttons which allow the user to download a JSON of the input values. So they can be downloaded and re-uploaded for future use and troubleshooting. These should be in the top left corner as a dropdown (with any other file-related functions)
